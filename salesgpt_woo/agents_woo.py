...
from salesgpt_woo.chains_woo import SalesConversationChain, StageAnalyzerChain, ProductAnalyzerChain
from salesgpt.logger import time_logger
from salesgpt.stages import CONVERSATION_STAGES
import salesgpt_woo.db_retriver as retriver
...
class SalesGPT(Chain, BaseModel):
    ...
    customer_interest: str = "hi"
    current_conversation_stage: str = CONVERSATION_STAGES.get("1")
    stage_analyzer_chain: StageAnalyzerChain = Field(...)
    product_analyzer_chain: ProductAnalyzerChain = Field(...)
    ...
    @time_logger
    def determine_customer_interest(self):
        self.customer_interest = self.product_analyzer_chain.predict(
            conversation_history="\n".join(self.conversation_history).rstrip("\n"),
    ...
    def step(self, return_streaming_generator: bool = False):
        ...
        print("customer interest:" + self.customer_interest)
    ...
    def _call(self, inputs: Dict[str, Any]) -> None:
        ...
        if len(self.conversation_history)==0:
            ...
            docs_str = retriver.documents_to_string(retriver.get_documents(retriver.get_db(), self.determine_customer_interest()))
    ...
    def from_llm(cls, llm: BaseLLM, verbose: bool = False, **kwargs) -> "SalesGPT":
        ...
        product_analyzer_chain = ProductAnalyzerChain.from_llm(llm, verbose=verbose)
        if (
        ...
        return cls(
            ...
            product_analyzer_chain=product_analyzer_chain,
